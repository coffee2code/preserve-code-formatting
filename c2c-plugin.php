...
if ( ! class_exists( 'c2c_PreserveCodeFormatting_Plugin_050' ) ) :

abstract class c2c_PreserveCodeFormatting_Plugin_050 {
	 ...
	 * @since 036
	 */
	public function __clone() { _doing_it_wrong( __FUNCTION__, __( 'Something went wrong.', 'preserve-code-formatting' ), '036' ); }
	 ...
	 * @since 036
	 */
	public function __wakeup() { _doing_it_wrong( __FUNCTION__, __( 'Something went wrong.', 'preserve-code-formatting' ), '036' ); }
...
HTML;
	...
	public function donate_link( $links, $file ) {
		if ( $file == $this->plugin_basename ) {
			...
			$links[] = '<a href="' . esc_url( $donation_url ) . '" title="' . esc_attr( $title ) . '">' . __( 'Donate', 'preserve-code-formatting' ) . '</a>';
		}
		return $links;
	}
...
//				echo '<div class="hr">&nbsp;</div>' . "\n";
	...
	public function options_page() {
		...
		printf(
			...
			esc_attr__( 'Please consider a donation', 'preserve-code-formatting' ),
