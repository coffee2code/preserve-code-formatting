...
final class c2c_PreserveCodeFormatting extends c2c_PreserveCodeFormatting_Plugin_050 {
	/**
	...
	protected function __construct() {
		parent::__construct( '3.9.2', 'preserve-code-formatting', 'c2c', __FILE__, array() );
