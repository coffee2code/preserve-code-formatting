...
class Preserve_Code_Formatting_Test extends WP_UnitTestCase {
	...
	public function test_plugin_framework_class_name() {
		$this->assertTrue( class_exists( 'c2c_PreserveCodeFormatting_Plugin_046' ) );
	}

	public function test_plugin_framework_version() {
		$this->assertEquals( '046', c2c_PreserveCodeFormatting::get_instance()->c2c_plugin_version() );
	}

	public function test_get_version() {
		$this->assertEquals( '3.8', c2c_PreserveCodeFormatting::get_instance()->version() );
	}
